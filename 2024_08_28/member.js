const members = [
    {
        name: '박가온누리',
        short: 'Java 뿌시겠습니다!!',
        description: 'MBTI: INFP<br>장점: 기본 이론을 베이스로 응용력이 좋고, 기획력이 뛰어나다.<br>협업 스타일: 팀원들과 꾸준히 진척도를 공유하기',
    ...
    },
    {
        name: '김명훈',
        short: '잘부탁드립니다',
        description: 'MBTI: ENFJ<br>장점: 실패를 두려워 하지 않는 무한 긍정 마인드와 스트레스를 빠르게 극복하는 회복탄력성.<br>협업 스타일: 팀으로 묶인 이상 낙오는 없다. 내가 부족한 건 노력을 들여서 더 공부하고, 어려움에 처한 팀원은 이끌어서 함께 가자.',
    ...
    },
    {
        name: '허원경',
        short: '열심히 할께요.. ㅇ.<',
        description: 'MBTI: ISFJ<br>장점: 고집이 센 편이라 어떻게든 해결해보려고 시도함<br>협업 스타일: 부족한 부분은 최대한 따라가려고 노력하기.',
    ...
    },
    {
        ...
        description: 'MBTI: INTP<br>장점: 한번 앉으면 목표한 만큼 해내기 전까지 일어나지 않는다.<br>협업 스타일: 모르는 것은 먼저 물어보고, 아는 것은 먼저 말해주면서 서로서로 윈윈할 수 있는 스타일',
    ...
    },
    {
        name: '민지형',
        short: '잘 배워보겠습니다ㅎㅎ..',
        description: 'MBTI: ISFP<br>장점: 탁월한 끈기와 인내심, 그리고 한가지에 높은 집중력<br>협업 스타일: 팀의 필요에 맞춰 유연하게 조정하고, 효율적으로 조화를 이루기.',
...
function openModal(index) {
    ...
    modalDescription.innerHTML = member.description;
